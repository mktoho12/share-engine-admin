...
export default function Page() {
  ...
  const { data, refetch } = useReadUser(userId ?? 0, {
    query: { enabled: false },
  })
  ...
  return (
    <main className="p-4 text-sm">
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-lg max-w-[970px] mx-auto">
        <div className="relative h-[140px] md:h-[260px]">
          <Image
            src="/images/forgery/tokisaba-cover.jpg"
            alt="tokisaba cover picture"
            width={970}
            height={260}
            className="object-cover aspect-[970/260]"
          />
          <div className="absolute bottom-1 right-1 md:bottom-4 md:right-4">
            ...
            >
              <input id="cover" className="sr-only" type="file" name="cover" />
              <span>
                <svg
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-[46px] text-gray-400">
          <div className="relative mx-auto -mt-[88px] h-[120px] w-full max-w-[120px] rounded-full bg-white/20 p-1 backdrop-blur sm:h-[176px] sm:max-w-[176px] sm:p-3">
            <div className="relative drop-shadow-2">
              <Image
                src="/images/forgery/tokisaba-icon.jpg"
                alt="tokisaba"
                width={160}
                height={160}
              ...
              <label
                htmlFor="profile"
                className="absolute bottom-0 right-0 flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
              >
                <svg
                  className="fill-current"
                  width="14"
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">Sharehouse Organizer</p>
            <div className="mx-auto mb-[22px] mt-[18px] grid max-w-[372px] grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 md:flex-row">
                <span className="font-semibold text-black">
                  {data?.own_items?.length}
                </span>
                <span className="text-sm">Items</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 md:flex-row">
                <span className="font-semibold text-black">
                  {data?.rent_items?.length}
                </span>
                <span className="text-sm">Rent</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 px-4 md:flex-row">
                <span className="font-semibold text-black">
                  {data?.own_items?.filter(i => i.available).length}
                </span>
